...
{
	std::cout << "Frame width: " << figure->getFrameRect().width << " height: " << figure->getFrameRect().height << std::endl;
	std::cout << "Frame center x: " << figure->getFrameRect().pos.x << " y: " << figure->getFrameRect().pos.y << std::endl;
	std::cout << "Area: " << figure->getArea() << std::endl;
	std::cout << std::endl;
	figure->move(point_t{ 6,2 });
	std::cout << "Move (x=6 y=2) " << std::endl;
	std::cout << "Frame width: " << figure->getFrameRect().width << " height: " << figure->getFrameRect().height << std::endl;
	std::cout << "Frame center x: " << figure->getFrameRect().pos.x << " y: " << figure->getFrameRect().pos.y << std::endl;
	std::cout << "Area: " << figure->getArea() << std::endl;
	std::cout << std::endl;
	figure->move(4, 2);
	std::cout << "Move (dx=4 dy=2) " << std::endl;
	std::cout << "Frame width: " << figure->getFrameRect().width << " height: " << figure->getFrameRect().height << std::endl;
	std::cout << "Frame center x: " << figure->getFrameRect().pos.x << " y: " << figure->getFrameRect().pos.y << std::endl;
	std::cout << "Area: " << figure->getArea() << std::endl;
	std::cout << std::endl;
	...
	std::cout << "Frame width: " << figure->getFrameRect().width << " height " << figure->getFrameRect().height << std::endl;
	std::cout << "Frame x: " << figure->getFrameRect().pos.x << " y: " << figure->getFrameRect().pos.y << std::endl;
	std::cout << "Area: " << figure->getArea() << std::endl;
	std::cout << std::endl;
	std::cout << "=============================================================" << std::endl;
	std::cout << std::endl;
...
int main()
{
	try
	{
		...
		std::shared_ptr<Shape> rectangle = std::make_shared<Rectangle>(rectanglePoint_1, rectanglePoint_2);
		...
		std::shared_ptr<Shape> circle = std::make_shared<Circle>(circlePoint, circleRadius);
		...
		std::shared_ptr<Shape> complexquad = std::make_shared<Complexquad>(complexquadPoint_1, complexquadPoint_2, complexquadPoint_3, complexquadPoint_4);
